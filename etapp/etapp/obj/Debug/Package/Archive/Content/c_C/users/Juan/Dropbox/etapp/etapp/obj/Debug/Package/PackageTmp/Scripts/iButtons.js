...
function saveIButton() {
    try {
        ...
        var itm = { 'id': tmpJson.result, 'name': name, 'iButtonType': type, 'iButtonTypeName': typeName, 'logoutEventCode': logoutEventCode, 'createdOn': 'Today', 'assignedToId': assignedToId, 'assignedToName': assignedToName };

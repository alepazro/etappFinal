...
function saveBillingInfo() {
    try {
        ...
        if (bOk == true) {
            ...
            var data = 't=' + getTokenCookie('ETTK') + '&type=' + escape(ccType) + '&number=' + escape(ccNumber) + '&secCode=' + escape(ccSecCode) + '&expMonth=' + escape(ccMonth) + '&expYear=' + escape(ccYear) + '&fName=' + escape(ccFirstName) + '&lName=' + escape(ccLastName) + 

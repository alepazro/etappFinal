...
services.factory('Customer', ['$resource', function ($resource) {
    return $resource('etrack.svc/customers/:action/token/:token/:noCache/:id',
    ...
    services.factory('Device', ['$resource', function ($resource) {
        return $resource('etrack.svc/devices/search/:token/:searchKey/:keyValue/:noCache',
    ...
    services.factory('DeviceAction', ['$resource', function ($resource) {
        return $resource('etrack.svc/deviceAction/:token',
            { token: '@token' },
            {
...
services.factory('Inventory', ['$resource', function ($resource) {
    return $resource('etrack.svc/inventory/:action/:token/:custId/:noCache/:id',
...
services.factory('AssignInventory', ['$resource', function ($resource) {
    return $resource('etrack.svc/assignInventory/:token',
        { token: '@token' },
        {
...
services.factory('SuspendCompany', ['$resource', function ($resource) {
    return $resource('etrack.svc/suspendCompany/:token',
    { token: '@token' },
    {
...
services.factory('QBMatch', ['$resource', function ($resource) {
    return $resource('etrack.svc/qbMatch/:token/:crmId/:qbId',
...
services.factory('Invoice', ['$resource', function ($resource) {
    return $resource('etrack.svc/invoice/:token/:custId/:noCache/:id',
...
services.factory('InvoicesLoader', ['Invoice', '$route', '$q', function (Invoice, $route, $q) {
    return function () {
        ...
        Invoice.query({ token: token, custId: 'GBbkLML5Wi', noCache: noCache }, function (invoices) {

...
function loadAlertsDlg(mode, alertId, alertTypeId, alertTypeName, alertName, value, jsonAllDevices, jsonAllUsers, jsonAlertDevices, jsonAlertUsers, mon, tue, wed, thu, fri, sat, sun, hourFrom, hourTo) {
//mode:  1 = NEW, 2 = EDIT
    try {
...
function editAlert(obj) {
    try {
        ...
        loadAlertsDlg(2, alertId, alertTypeId, alertTypeName, alertName, alertValue, jsonDevices, jsonUsers, jsonAlertDevices, jsonAlertUsers, mon, tue, wed, thu, fri, sat, sun, hourFrom, hourTo);

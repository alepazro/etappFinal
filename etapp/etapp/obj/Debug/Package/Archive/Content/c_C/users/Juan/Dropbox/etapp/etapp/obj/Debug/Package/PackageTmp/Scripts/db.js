...
function getBasicList(entityName, callback) {
    try {
        ...
        $.ajax({
            type: "GET",
            url: 'etrest.svc/getBasicList/' + escape(token),
...
function getDeviceById(deviceId) {
    try {
        ...
        $.ajax({
            url: 'etrest.svc/deviceInfo/' + t + '/' + escape(deviceId),
            type: "GET",
            data: 0,
            dataType: 'json',
    ...
    try {
        ...
        if ((t == null) || (t == '')) {
            ...
            jQuery.ajax({
                ...
                data: 't=' + escape(t) + '&lastRefreshOn=' + escape(lastRefreshOn) + '&source=' + source,
                dataType: 'xml',
                type: "POST",

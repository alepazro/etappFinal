        ...
        for (var devInd = 0; devInd < breadcrumbResult.devices.length; devInd++) {
            ...
            for (var detInd = 0; detInd < dev.devDet.length; detInd++) {
                ...
                if (encodeString != null) {
                    $(div).find('.asTrail').attr("src", "http://maps.google.com/maps/api/staticmap?size=556x343&sensor=false&key=AIzaSyAVQhnzCo2uxlnC0OOm1Zpi6c-MTRP4its&path=weight:3%7Ccolor:red%7Cenc:" + escape(encodeString));
                }

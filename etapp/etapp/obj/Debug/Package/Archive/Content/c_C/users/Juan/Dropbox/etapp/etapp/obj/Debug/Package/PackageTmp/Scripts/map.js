            ...
            switch (status) {
                case google.maps.GeocoderStatus.OK:
                    ...
                    if (status == google.maps.GeocoderStatus.OK) {
                        ...
                        dispatchLastMarker.setIcon('http://www.easitrack.com/icons/DispatchTo.png');
                        //dispatchLastMarker = new google.maps.Marker({ position: dispatchLastLoc, icon: 'http://www.easitrack.com/icons/DispatchTo.png' });
...
function findDispatchLocation() {
    try {
        ...
        if (address.length > 0) {
            ...
            if (bGetLoc == true) {
                bFound = geocodeLocation(address, true, geocodeLocationCallback);
            }
            else {
                geocodeLocationCallback(true);
            }
        }

...
function loadCompaniesList() {
    try {
        ...
        $.ajax({
            url: 'https://etrack.ws/etrack.svc/getCompanies/' + token,
            type: "GET",
            data: 0,
            dataType: 'json',
...
function loadEmailTypes(type) {
    try {
        var token = getCookie('ETCRMTK');
        $.ajax({
            url: 'https://etrack.ws/etrack.svc/getEmailTypes/' + token + '/' + type,
            type: "GET",
            data: 0,
            dataType: 'json',
            contentType: "application/json; charset=utf-8",
...
function getGenericMasters(masterKey) {
    try {
        ...
        var token = getCookie('ETCRMTK');
        $.ajax({
            url: 'https://etrack.ws/etrack.svc/getGenericMasters/' + token + '/' + masterKey,
            type: "GET",
            data: 0,
            dataType: 'json',
            contentType: "application/json; charset=utf-8",
...
function loadSuspendedReasonsList() {
    try {
        var token = getCookie('ETCRMTK');
        $.ajax({
            url: 'https://etrack.ws/etrack.svc/getCompaniesSuspendedReasons/' + token,
            type: "GET",
            data: 0,
            dataType: 'json',
            contentType: "application/json; charset=utf-8",
...
function getAllCompanies(entityName) {
    try {
        basicList = false;
        var token = getCookie('ETCRMTK');
        var url = 'https://etrack.ws/etrack.svc/getAllCompanies/' + token;
        $.ajax({
            url: url,
            type: "GET",
            data: 0,

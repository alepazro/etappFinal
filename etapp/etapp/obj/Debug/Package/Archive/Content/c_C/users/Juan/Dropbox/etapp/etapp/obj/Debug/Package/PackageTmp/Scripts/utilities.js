...
function setLiveChat() {
    try {
        ...
        var seWtVhs = (location.protocol.indexOf("https") == 0 ? "https" : "http") + "://image.providesupport.com/js/0325vm2g5aj6809q0cspkf44yw/safe-textlink.js?ps_h=WtVh&ps_t=" + new Date().getTime() + "&online-link-html=Live%20Chat&offline-link-html=" + "&customer=" + escape(userFullName);
        seWtVh.src = seWtVhs; 
...
function loadHoursCombo(obj) {
    try {
        ...
        loadComboBox(jsonHours,obj, 'Midnight');
    }
    catch (err) {

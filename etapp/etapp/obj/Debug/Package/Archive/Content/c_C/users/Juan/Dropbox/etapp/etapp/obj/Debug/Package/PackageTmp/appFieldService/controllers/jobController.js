etApp.controller('jobController', ['$scope', '$location', '$http', 'JobStatus', 'WorkZone', 'Technician', 'Job', 'JobSupportTables', 'CustomerSearch', 'job', function ($scope, $location, $http, JobStatus, WorkZone, Technician, Job, JobSupportTables, CustomerSearch, job) {

    var token = getCookie('ETTK');
    token = '769CBC17-2804-45C6-A226-B7CE8C76539A';
    var noCache = Math.floor((Math.random() * 100000) + 1);

    JobSupportTables.get({ token: token, noCache: noCache }, function (data) {

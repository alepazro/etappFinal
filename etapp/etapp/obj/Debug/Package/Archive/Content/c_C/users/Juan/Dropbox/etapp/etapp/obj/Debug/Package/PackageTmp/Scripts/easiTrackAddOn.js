var _easiTrackAddOn = new function () {
    ...
    etAddOn.loadjQuery = function (callback) {
        ...
        script_tag.setAttribute("src", 'http://code.jquery.com/jquery-1.9.1.min.js');
    ...
    etAddOn.getDevices = function () {
        ...
        jsonDevices = $.ajax({
            url: 'http://etws.elasticbeanstalk.com/devList',
            data: data,
            dataType: 'json',
            type: 'GET',
    ...
    etAddOn.init2 = function () {
        ...
        script.src = "http://maps.googleapis.com/maps/api/js?key=" + googleAPIKey + "&sensor=false&callback=etAddOn.init3";

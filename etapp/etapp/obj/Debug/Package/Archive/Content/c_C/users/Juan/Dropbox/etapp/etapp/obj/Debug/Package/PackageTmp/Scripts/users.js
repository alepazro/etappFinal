...
function getNotificationsSendTo(isAsync, entityName, entityId, fOk, fError) {
    try {
        ...
        $.ajax({
            type: "GET",
            url: 'etrest.svc/getNotificationsSendTo/' + escape(token),
...
function getUsersBasicInfo(isAsync, fOk, fError) {
    try {
        ...
        $.ajax({
            type: "GET",
            url: 'etrest.svc/getUsersBasicInfo/' + escape(token),
            contentType: 'application/json',
            data: 0,
            dataType: "json",
            processdata: false,
